...
const AddVisa = () => {
  ...
  // ২. ইমেজ সিলেক্ট ও Native Compressor প্রয়োগ
    ...
    try {
      const processedImages = await Promise.all(
        files.map(async (file) => {
          // Native Image Compression (1600x1600 resolution limit, 0.7 quality)
  ...
  // ৩. ইমেজ রিমুভ ও মেমোরি ক্লিনআপ (Revoke Blob URL)
                ...
                <div className="col-12 mt-4">
                  ...
                  <div className="d-flex flex-wrap gap-2 mb-3">
                    {requirementsList.map((req, index) => (
                      <span
                        key={index}
                        className="badge bg-light text-dark border d-flex align-items-center p-2 rounded-pill shadow-sm"
                      >
                        <FaPassport
                          className="me-2 text-teal"
              ...
              >
                ...
                <label htmlFor="visaFile" className="cursor-pointer w-100 mb-0">
                  {isCompressing ? (
                    <>
                      <FaSpinner
                        className="spinner-border text-teal mb-2"
                ...
                {selectedImages.map((file, i) => (
                  <div key={i} className="col-4 position-relative">
                    ...
                    <button
                      ...
                      className="btn btn-danger btn-sm position-absolute top-0 end-0 p-0 shadow-sm"
                      style={{
                        width: "20px",
                        height: "20px",
                        fontSize: "12px",
